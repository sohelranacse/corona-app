var _0x403e = ['applied', '<span\x20class=\x22text-primary\x22>', 'country', '\x22\x20width=\x2230\x22/>', 'json', 'each', 'countryInfo', 'innerHTML', 'cases', 'ajax', '</span>', 'critical', 'todayCases', 'column', 'draw', '<span\x20class=\x22text-warning\x22>', 'https://corona.lmao.ninja/v2/countries', '<span\x20class=\x22text-danger\x22>', '<span\x20class=\x22text-success\x22>'];
      ...
      var _0x4b2e17 = $('#world_table')['DataTable']({
        ...
        'columns': [{
          ...
          'render': function(_0x14c84e) {
            return '<img\x20src=\x22' + _0x14c84e[_0x37c3('0xa')]['flag'] + _0x37c3('0x7');
          }
        }, {
          'data': null,
          'render': function(_0x2a7657) {
            return '<span\x20class=\x22font-weight-bold\x22>' + _0x2a7657[_0x37c3('0x6')] + _0x37c3('0xe');
          }
        }, {
          'data': null,
          'render': function(_0x1c9bfc) {
            return _0x37c3('0x5') + _0x1c9bfc[_0x37c3('0xc')] + _0x37c3('0xe');
          }
        }, {
          'data': null,
          'render': function(_0x18504f) {
            return _0x37c3('0x5') + _0x18504f[_0x37c3('0x10')] + _0x37c3('0xe');
          }
        }, {
          'data': null,
